...
path1 = "/home/wei/Downloads/testfile4.txt.gz"
monthDict = {'Jan':1, 'Feb':2, 'Mar':3, 'Apr':4, 'May':5, 'Jun':6, 'Jul':7, 'Aug':8, 'Sep':9, 'Oct':10, 'Nov':11, 'Dec':12}
#===============================================================================
# take .gz json string file and return a dictionary for each json block
#===============================================================================
def ReadFile(path):
    for tweet in TweetFiles.iterateTweetsFromGzip(path):
        print tweet
#print ReadFile(path1)
#===============================================================================
# take .gz json string file and return a dictionary map with key ID and value username
#===============================================================================
def UserIdNameDict(path):
    ...
    return dict1
#print UserIdNameDict(path1)
#===============================================================================
# take .gz json string file and return a dictionary with key docID and value words in Doc
# then map to the frequency of words occurred in the file
#===============================================================================
...
#-------------------------------------------------------- DocWordFreqDict(path1)
        ...
        #-------------------------- for puretweet in tweet['text'].split('\W+'):
            ...
            if(puretweet in dict2[docNum].keys()):
                ...
                dict2[docNum][puretweet] = 1
    return dict2
#print DocWordFreqDict(path1)
#===============================================================================
# build a full dictionary with all necessary dimensions included
#===============================================================================
def DocidWordFreqTimeLocationDict(path):
    #---------------------- use each tweet as a doc. here may not be appropriate
    #---------------------------------------------------------------- initialize
...
#f.close()
#DocidWordFreqTimeLocationDict(path1)    
