...
#build dictionary with all existing words in the collection
...
n=0
while (log_prob_C_new >= log_prob_C_old) and n<10:
    n+=1
#Expectation part 
    for docId in dict2.keys():
...
for time in timeStampToDocIdDict.keys():
    prob_t_theme_numerator[time]=prob_theta_timeloc[time][1]
...
f= open('/home/wei/Downloads/temproaltheme.txt','w')
